    ...
    return (
        <div className='flex gap-5 items-center flex-col-reverse md:flex-row'>
            <div className='w-100 md:w-4/12 space-y-5'>
                <h1 className='text-5xl font-semibold font-kalam'>Chinese <br className='hidden md:block'/> Cuisine</h1>
                ...
                <button className='bg-orange-500 px-4 py-3 text-xl font-semibold rounded-xl border-none text-white'>View Our Chefs</button>
            </div>
