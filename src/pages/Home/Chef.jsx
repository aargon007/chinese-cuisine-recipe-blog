    ...
    return (
        <div className='flex gap-3 bg-amber-200 rounded-xl '>
            <div className='w-7/12 p-5 leading-loose space-y-5'>
                ...
                <button className='bg-amber-600 px-3 py-2 hover:bg-amber-800 transition-all rounded-xl border-none text-white'>View Recipes</button>
            </div>
            <div className='w-5/12'>
                <img src={picture} alt=""  className='w-full h-[300px] object-cover rounded-r-xl'/>
            </div>
        </div>
    );
};
